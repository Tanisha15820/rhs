...
import imgTop from '../../assets/images/cyberblade_top.svg';
import imgMid1 from '../../assets/images/cyberblade_mid1.svg';
import imgMid2 from '../../assets/images/cyberblade_mid2.svg';
import imgBase from '../../assets/images/cyberblade_base.svg';
      ...
      <div className={`relative mx-auto flex w-full max-w-[1000px] items-center justify-center px-4 transition-all duration-500 ${isExploded ? 'min-h-[540px] sm:min-h-[700px] lg:min-h-[950px]' : 'min-h-[480px] sm:min-h-[630px] lg:min-h-[850px]'}`}>
        ...
        <div className="relative z-20 flex h-[480px] w-[300px] cursor-pointer items-center justify-center sm:h-[630px] sm:w-[340px] lg:h-[850px] lg:w-[480px]" onClick={toggleMachine}>
          ...
          <div className="absolute left-1/2 top-1/2 h-[1050px] w-[520px] -translate-x-1/2 -translate-y-1/2 scale-[0.45] sm:scale-[0.6] lg:scale-[0.85] origin-center">
            <img src={imgTop} alt="CyberBlade Display" draggable={false} style={getExplodeStyle(-1.5)} className="pointer-events-none absolute left-[10px] top-[20px] z-10 w-[500px] h-[300px] select-none object-contain transition-transform duration-500 mix-blend-multiply" />
            <img src={imgMid1} alt="CyberBlade Console" draggable={false} style={getExplodeStyle(-0.5)} className="pointer-events-none absolute left-[60px] top-[300px] z-20 w-[400px] h-[200px] select-none object-contain transition-transform duration-500 mix-blend-multiply" />
            <img src={imgMid2} alt="CyberBlade Processing" draggable={false} style={getExplodeStyle(0.5)} className="pointer-events-none absolute left-[60px] top-[480px] z-30 w-[400px] h-[250px] select-none object-contain transition-transform duration-500 mix-blend-multiply" />
            <img src={imgBase} alt="CyberBlade Base" draggable={false} style={getExplodeStyle(1.5)} className="pointer-events-none absolute left-[10px] top-[710px] z-40 w-[500px] h-[300px] select-none object-contain transition-transform duration-500 mix-blend-multiply" />
          </div>
        </div>
      </div>

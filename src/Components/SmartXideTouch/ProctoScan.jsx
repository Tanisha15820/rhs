      ...
      <div className="relative z-10 mx-auto max-w-7xl px-5 sm:px-8 lg:px-10">
        <div className="grid items-center gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:gap-12">
          ...
          <div className="relative">
            <div className="relative flex flex-col items-center sm:min-h-[480px]">
              {/* Product Area */}
              <div
                className="
                  relative
              ...
              >
                ...
                <div className="absolute left-[8%] top-[20%] h-[270px] w-[270px] rounded-full border border-[#BFE7F7] sm:left-[13%]" />

                <div className="absolute left-[13%] top-[25%] h-[220px] w-[220px] rounded-full border border-[#D4EFF8] sm:left-[18%]" />
            ...
            >
              {/* Scanning Area */}
              <div className="grid grid-cols-[145px_1fr] items-center border-b border-[#E9F0F6] px-4 py-3 sm:grid-cols-[180px_1fr]">
              ...
              {/* Dwell Time */}
              <div className="grid grid-cols-[145px_1fr] items-center px-4 py-3 sm:grid-cols-[180px_1fr]">
                <div className="flex items-center gap-2.5">
            ...
            >
              ...
              <div className="mt-5 grid grid-cols-4 gap-3">
                ...
                <div className="flex flex-col items-center">
                  <img
                    src={dothexagonImg}
                    alt="DOT Hexagon scanning shape"
                    className="h-14 w-14 object-contain"
                  />

...
const machinePoints = [
  { title: "Applicator Handpiece", description: "Shockwave Delivery" },
  { title: "Display Screen", description: "Treatment Interface" },
  { title: "Intensity Controls", description: "Energy Adjustment" },
  { title: "Base Unit", description: "System Core" },
  { title: "Mobile Cart", description: "Easy Transport" },
];

const VibrolithOrthoMachine = () => {
      ...
      <div className="relative mx-auto flex w-full max-w-[720px] items-start justify-center px-4 sm:px-5 min-h-[340px] sm:min-h-[390px] lg:min-h-[280px] lg:items-center">
        ...
        >
          <AnimatePresence>
            {isExpanded && (
              <>
                <KeyPoint title="Applicator Handpiece" description="Shockwave Delivery" position="left-[-180px] top-[40px]" side="left" lineWidth={40} />
                <KeyPoint title="Display Screen" description="Treatment Interface" position="right-[-180px] top-[80px]" side="right" lineWidth={50} />
                <KeyPoint title="Intensity Controls" description="Energy Adjustment" position="left-[-190px] top-[150px]" side="left" lineWidth={45} />
                <KeyPoint title="Base Unit" description="System Core" position="right-[-160px] top-[220px]" side="right" lineWidth={45} />
                <KeyPoint title="Mobile Cart" description="Easy Transport" position="left-[-160px] top-[260px]" side="left" lineWidth={40} />
              </>
            )}
          </AnimatePresence>
          ...
          <div className="relative z-10 flex h-[450px] w-full items-center justify-center">
            ...
            <motion.img
              src={machineImg}
              alt="Vibrolith Ortho Machine Top"
              draggable={false}
              ...
              animate={{ y: isExpanded ? -40 : 0, x: isExpanded ? -25 : 0 }}
            ...
            <motion.img
              src={machineImg}
              alt="Vibrolith Ortho Machine Mid Top"
              draggable={false}
              className="absolute inset-0 h-full w-full select-none object-contain mix-blend-multiply"
            ...
            <motion.img
              src={machineImg}
              alt="Vibrolith Ortho Machine Mid Bottom"
              draggable={false}
              className="absolute inset-0 h-full w-full select-none object-contain mix-blend-multiply"
            ...
            <motion.img
              src={machineImg}
              alt="Vibrolith Ortho Machine Bottom"
              draggable={false}
              className="absolute inset-0 h-full w-full select-none object-contain mix-blend-multiply"
              style={{ clipPath: "polygon(0 70%, 100% 70%, 100% 100%, 0 100%)" }}
              animate={{ y: isExpanded ? 45 : 0, x: isExpanded ? 20 : 0 }}
              transition={{ duration: 0.5, ease: "easeOut" }}
            />
          </div>
        </div>
...
export default VibrolithOrthoMachine;

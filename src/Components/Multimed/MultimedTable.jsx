  ...
  const tableSpecs = [
    {
      ...
      value: "300 mm (motorized)",
    },
    {
      label: "Longitudinal Movements",
      value: "150 mm",
    },
    {
    ...
    },
    {
      ...
      value: "600 mm x 2430 mm",
    },
    {
      label: "Table Height Range",
      value: "850 – 1150 mm",
    },
    {
      label: "Tilt Capability",
      value: "Motorized Trendelenburg & Lateral Tilting",
    },
    {
      label: "Patient Weight Rating",
      value: "155 kg tare / 200 kg dynamic",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-14 text-center">
          ...
          <p className="mx-auto mt-4 max-w-3xl text-sm leading-6 text-[#697A94] sm:text-base">
            The MULTIMED treatment table is capable of radiolucent scopy from
            any part of the patient's lying surface. Beyond ESWL shockwave
            therapy, its universal motorized adjustability supports a complete
            spectrum of endo-urological procedures.
          </p>
        </div>
        ...
        <div className="grid items-center gap-10 lg:grid-cols-12">
            ...
            <div className="mb-5 flex items-center gap-3">
              ...
              <div>
                ...
                <p
                  ...
                  "
                >
                  Smooth, silent electronic positioning with wired remote
                  control
                </p>
              </div>
            </div>
          ...
          >
            ...
            <p
              ...
              "
            >
              With motorized Trendelenburg and lateral tilt, the table can be
              stopped and fixed at any desired angle, transforming the
              lithotripsy room into a high-utility intervention suite.
            </p>
            ...
            <div
              ...
              "
            >
              Radiolucent Carbon Fiber • 200 kg Lifting Capacity • Trendelenburg
              Tilt
            </div>
          </div>
        </div>

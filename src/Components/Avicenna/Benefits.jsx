...
const Benefits = () => {
  const advantages = [
    {
      title: "Surgeon Comfort",
      description:
        "Ergonomic seated operation provides a more comfortable working position during procedures.",
      icon: ScanLine,
    ...
    },
    {
      ...
      description:
        "Accurate and fine control of ureterorenoscopic movements for improved intrarenal maneuverability.",
      icon: FileCheck,
    ...
    },
    {
      ...
      description:
        "Helps reduce the surgeon’s exposure to radiation during fluoroscopy-assisted procedures.",
      icon: Network,
    ...
    {
      title: "Extended Scope Life",
      description:
        "Controlled robotic manipulation helps reduce stress on the ureterorenoscope and supports longer instrument life.",
      icon: Gem,
    ...
    },
    {
      ...
      description:
        "Control irrigation flow and integrate endoscopic and fluoroscopic imaging directly from the surgeon console.",
      icon: Sparkles,
    ...
    <section className="relative overflow-hidden bg-[#F8FAFE] py-20">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-5">
        ...
        <p className="mt-3 text-center text-base text-[#7181A3] md:text-lg">
          Ergonomic control. Greater precision. Smarter fURS workflow.
        </p>
            ...
            {advantages.map((item, index) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <h3 className="mb-2 text-base font-bold leading-5">
                      {item.title}
                    </h3>

                    <p className="mb-3 text-xs leading-5 text-white/95">
                      {item.description}
                    </p>
                  </div>
                </div>

...
import avicennaImg from "../assets/images/avicenna.png";
      ...
      <section className="relative min-h-[500px] overflow-hidden bg-background sm:min-h-[600px] lg:min-h-[680px]">
        ...
        <div className="relative z-10 mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-10">
          ...
          <div className="relative mx-auto mt-2 max-w-[1200px] sm:mt-3">
            ...
            <FeatureCard
              number="01"
              description="Comfortable seated operation with precise robotic control of ureteroscope movements."
              image={articulatedArm}
              position="left-8 top-20"
            />
            <FeatureCard
              number="02"
              description="Enables accurate, smooth and fine movements during flexible ureteroscopy procedures."
              image={hollowFiber}
              position="bottom-16 left-8"
            />
            <FeatureCard
              number="03"
              description="Helps minimize radiation exposure for surgeons during fluoroscopy-assisted procedures."
              image={diodeImage}
              position="bottom-80 right-8"
            />
            <FeatureCard
              number="04"
              description="Supports irrigation control and integration with endoscopic and fluoroscopic imaging from the control console."
              image={diodeImage}
